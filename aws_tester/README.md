...
This project contains the infrastructure and deployment configuration for **lambdaforge-dev**.

- **Environment:** Development
- **AWS Region:** Auto-detected from AWS CLI configuration
- **Generated:** 2025-06-17T22:07:22.369Z
...
unzip lambdaforge-dev-infrastructure.zip
cd lambdaforge-dev-infrastructure/

...
# Option 1: AWS Credentials (For Development/Testing)
# Uncomment and fill in your AWS credentials:
# AWS_ACCESS_KEY_ID="YOUR_ACCESS_KEY_HERE"
# AWS_SECRET_ACCESS_KEY="YOUR_SECRET_KEY_HERE"

# Option 2: IAM Roles (Recommended for Production)
# If running on EC2, ECS, or Lambda, IAM roles will be used automatically
# No configuration needed - just ensure your instance has the required IAM role

# Option 3: AWS CLI Profile
# Use a specific AWS CLI profile (if configured)
...
# export AWS_DEFAULT_REGION="${formData.awsRegion || 'us-east-1'}"
# =============================================================================

# Auto-detect AWS region from AWS CLI configuration
AWS_REGION=\$(aws configure get region)
if [ -z "\$AWS_REGION" ]; then
    echo "⚠️  No default region configured. Using ${formData.awsRegion || 'us-east-1'}"
...
Edit \`deploy.sh\` and uncomment/fill in your credentials:
\`\`\`bash
AWS_ACCESS_KEY_ID="YOUR_ACCESS_KEY_HERE"
AWS_SECRET_ACCESS_KEY="YOUR_SECRET_KEY_HERE"
\`\`\`
...
#### Option 2: IAM Roles (Recommended for Production)
If running on EC2, ECS, EKS, or Lambda:
...
The deployment script automatically detects your AWS permissions and selects the appropriate template (full or simplified)
